...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		open: function (group, opts) {
			...
			$.each(group, function(i, element) {
				...
				if (isString(href)) {
					...
					// "/mypage.pages #my_id" will load "/mypage.pages" and display element having id "my_id"
					if (type === 'ajax') {
		...
		_start: function (index) {
			...
			// Check before try to load; 'inline' and 'pages' types need content, others - href
	...
	F.helpers.overlay = {
		...
		onReady : function (opts, obj) {
			...
			if (!this.overlay) {
				...
				this.el     = document.all && !document.querySelector ? $('pages') : $('body');
